...
/**
 * Tries to convert a Long (which resembles the primary key of a {@link Category} to a Category entity using the
...
public class CategoryConverter implements GenericConverter {
	...
	public Object convert(Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		throw new IllegalArgumentException(source + " cannot be converted to a Category object");
	}
}
