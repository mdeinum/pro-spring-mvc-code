...
public interface CustomerService {
    ...
    /**
     * Handles the login logic. If the {@link Customer} can be retrieved and the password is correct we get the {@link Customer}. In all other cases we get a {@link AuthenticationException}.
