...
public class OrderController {
	...
	public void placeOrder(OrderForm orderForm, Account account) throws ParseException {
		OrderBuilder orderBuilder = new OrderBuilder()
				.deliveryDate(simpleDateFormat.parse(orderForm.getDeliveryDate())).account(account)
		...
		bookstoreService.createOrder(orderBuilder.build(true));
	}
