...
<head>
    <meta charset="utf-8">
    <c:set var="title.key">
        <tiles:insertAttribute name="title" defaultValue=" Your Home in Books"/>
    </c:set>
    <title>Bookstore | <spring:message code="${title.key}" /></title>
    ...
    <div id="wrap">
       ...
       <div class="center_content">
        <div class="left_content">
            <h1><spring:message code="${title.key}" /></h1>
