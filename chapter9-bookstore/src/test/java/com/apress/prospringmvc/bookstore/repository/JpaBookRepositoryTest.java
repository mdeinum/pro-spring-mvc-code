...
public class JpaBookRepositoryTest {
    ...
    public void setupData() {
        ...
        book = bookBuilder.description("Richard Dawkins' brilliant reformulation of the theory of natural selection")
                .author("Richard Dawkins").title("The Selfish Gene: 30th Anniversary Edition").isbn("9780199291151")
    ...
    public void testStoreBook() {
        Book book = bookBuilder.description("Something").author("JohnDoe").title("John Doe's life")
